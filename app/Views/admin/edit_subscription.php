...
<html>
	<head>
		...
		<title>Edit Subscription - Admin</title>
	...
	<body>
		...
		style="min-height: 83.3vh;">
			<div class="row mt-5 justify-content-center align-items-center">
				<div class="col-2"></div>
				<div class="col-8 p-0">
					<p class="fw-semibold">Form <span class="text-muted">| Subscription</span></p>
				</div>
				<div class="col-2"></div>
			</div>
			<div class="row mb-5 justify-content-center align-items-center">
				...
				<div class="col-8 border rounded px-5 py-4 justify-content-center align-items-center">
					...
					<form action="<?= base_url('/admin/home/form/subscription/save/' . $subs['id_langganan']) ?>" 
					method="POST">
						<?= csrf_field(); ?>
						<div class="row">
							<div class="col-12">
						...
						<div class="row">
							<div class="col">
								<div class="form-floating mb-3">
									<input type="number" min="1" name="total_hari" class="form-control"
									value="<?= $subs['total_hari'] ?>" required>
									<label for="kategori">Total Hari</label>
								</div>
							</div>
							<div class="col">
								<div class="form-floating mb-3">
									<input type="number" min="1" name="harga" class="form-control"
									value="<?= $subs['harga'] ?>" required>
									<label for="materi">Harga</label>
								</div>
							</div>
						</div>
						<div class="row px-2">
