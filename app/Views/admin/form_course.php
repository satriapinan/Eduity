		...
		style="min-height: 83.3vh;">
			...
			<div class="row justify-content-center align-items-center">
				...
				<div class="col-8 border rounded px-5 py-4 justify-content-center align-items-center">
					...
					<form action="<?= base_url('/admin/home/form/course/save') ?>" method="POST"
						...
						<div class="row">
							...
							<div class="col">
								<div class="form-floating mb-3">
									<input type="number" min="1" name="materi" class="form-control" required>
						...
						<div class="row">
							<div class="col">
								<div class="form-floating mb-3">
									<textarea name="deskripsi" class="form-control" style="height: 100px"></textarea required>
